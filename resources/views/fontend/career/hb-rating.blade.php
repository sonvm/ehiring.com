...
$rated = array_column($ratings, 'cv_id');
$criterias = array_column($ratings, 'name');
?>
...
@section('content')
    ...
    <div class="col-10 list-group mx-0">
        ...
        $keys = array_keys(array_column($ratings, 'cv_id'), $id);
        ?>
        ...
        <div class="form-check">
            ...
            <input type="range" class="form-range" min="1" max="5" step="1" value="{{$ratings[$key]['rating']}}" disabled>
